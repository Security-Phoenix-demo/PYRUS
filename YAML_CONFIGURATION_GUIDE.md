...
ConfigFiles:
  ...
  - /redacted-client-a/redacted-client-a-core-structure.yaml  # Subfolder path
...
- **Subfolder paths**: Start with `/` (e.g., `/redacted-client-a/config.yaml`)
...
```
``
for an OR condition: - Service: 123-OR

- Service: service123
    Type: Cloud
    Deployment_set: service123
    Tier: 5
    TeamName: service123-team
    MULTI_MultiConditionRules:
    - AssetType: CLOUD
      SearchName: ‘*service123*’
    - Tags:
      - “tag:system123”

This would read Search asset service123 OR search system with tags tag:system123
...
This would read Search asset service123 AND search system with tags tag:system123
