...
def extract_last_two_path_parts(repo_path):
    ...
    Args:
        repo_path (str): Full repository path like "gitlab.com/q2e/development/redacted-client-e/io-code-review-assistant"
        
    Returns:
        str: Last 2 parts like "redacted-client-e/io-code-review-assistant"
    """
