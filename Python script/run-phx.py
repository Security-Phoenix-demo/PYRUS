...
def get_config_files_from_resources_folder():
    """
        ...
        Supports subfolder paths like /redacted-client-a/redacted-client-a-core-structure.yaml
    """
    ...
    for config_file in config_files_to_use:
        # Handle subfolder paths (e.g., /redacted-client-a/redacted-client-a-core-structure.yaml)
